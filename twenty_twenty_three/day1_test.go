package twenty_twenty_three_test
...
import (
	...
	"github.com/mckornfield/aoc/twenty_twenty_three"
	"gotest.tools/assert"
)
...
// 	result := twenty_twenty_three.ReadFile("day1_pt1_example.txt")
...
// 	lines := strings.Split(twenty_twenty_three.ReadFile("day1.txt"), "\n")
// 	sum, err := getSumsFromLines(lines, getNumbersFromLine)
// 	assert.NilError(t, err)
...
func TestRunPt2Example(t *testing.T) {
	lines := strings.Split(twenty_twenty_three.ReadFile("day1_pt2_example.txt"), "\n")
